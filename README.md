...
- [**Download my CV (PDF)**](https://david.adei.love/files/david-cv.pdf)
- [**View Online**](https://david.adei.love/files/david-cv.pdf)

<details>
  <summary><strong>Click for a Quick CV Overview</strong></summary>
  ...
  **Selected Projects**
  - BBS04 Group Signatures Library (C++, Go, Java)
  - Witness Encryption (C++, Python)
  - Jäger: Automated Call Traceback
  - Cloud Secret Recovery (Python, AWS Nitro Enclaves)
...
- **Email:** [lokingdav@gmail.com](mailto:lokingdav@gmail.com)
- **LinkedIn:** [linkedin.com/in/lokingdav](https://www.linkedin.com/in/lokingdav/)
- **Website:** [david.adei.love](https://david.adei.love)

---

## ⚡ Fun Facts

- I love building cryptosystems that *work* in the wild, not just on paper.
- Always happy to collaborate or chat about research, protocols, or open-source development.
